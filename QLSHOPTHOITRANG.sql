...
create table MauEmail	
(
	MaMauEmail int identity primary key not null,
	SubjectEmail nvarchar(100),
	ContentEmail nvarchar(MAX),
)

insert into MauEmail values(N'Thông báo xác nhận đơn hàng',N'<table
        style="color: rgb(34, 34, 34); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: small; background-color: rgb(255, 255, 255); width: 948px; margin: 40px 0px 20px;">
        <tbody>
            <tr>
                <td style="margin: 0px;">
                    <center>
                        <table style="width: 560px; text-align: left; margin: 0px auto;">
                            <tbody>
                                <tr>
                                    <td style="margin: 0px;">
                                        <table style="width: 558px;">
                                            <tbody>
                                                <tr>
                                                    <td style="margin: 0px;">
                                                        <h1
                                                            style="margin-top: 0px; margin-bottom: 0px; font-size: 20px; color: rgb(51, 51, 51);">
                                                            MARKLEO.COM</h1>
                                                    </td>
                                                    <td
                                                        style="margin: 0px; text-transform: uppercase; font-size: 14px; text-align: right; color: rgb(153, 153, 153);">
                                                        <span style="font-size: 14px;">ĐƠN HÀNG #{{ORDERID}}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
    ...
    <table
        style="color: rgb(34, 34, 34); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: small; background-color: rgb(255, 255, 255); width: 948px;">
        <tbody>
            <tr>
                <td style="margin: 0px; padding-bottom: 40px;">
                    <center>
                        <table style="width: 560px; text-align: left; margin: 0px auto;">
                            <tbody>
                                <tr>
                                    <td style="margin: 0px;">
                                        ...
                                        <p
                                            style="margin-bottom: 0px; color: rgb(119, 119, 119); line-height: 24px; font-size: 16px;">
                                        ...
                                        <table style="width: 558px; margin-top: 20px;">
                                            <tbody>
                                                <tr>
                                                    <td style="margin: 0px;">
                                                        <table style="float: left; margin-right: 15px;">
                                                            <tbody>
                                                                <tr>
                                                                    <td
                                                                        style="margin: 0px; text-align: center; padding: 20px 25px; border-radius: 4px; background: rgb(234, 28, 0);">
                                                                        <a href="http://localhost:11173/"
                                                                            class="btn-go-to-store"
                                                                            style="display: inline-block; text-decoration: none; min-width: 100px; height: 25px; background-color: rgb(234, 28, 0); outline: none; border: none; color: #fff; border-radius: 4px; cursor: pointer; text-align: center; line-height: 25px;">Đến
                                                                            cửa hàng</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="margin: 0px;">
                                                        <p><br></p>
                                                        <h2
                                                            style="margin-top: 0px; margin-bottom: 0.5rem; line-height: 1.2; font-size: 1.5rem;">
                                                        ...
                                                        <table
                                                            style="color: rgb(72, 74, 76); font-family: Arial, Helvetica, sans-serif; font-size: 14px; width: 620px; max-width: 100%; margin-bottom: 1rem; border: 1px solid rgb(222, 226, 230);">
                                                            <thead>
                                                                <tr style="break-inside: avoid;">
                                                                    <th
                                                                        style="text-align: inherit;background-color: #455a64; color: #fff; padding: 0.75rem; vertical-align: bottom; border: 1px solid rgb(221, 221, 221) !important;">
                                                                        Mã SP</th>
                                                                    <th
                                                                        style="text-align: inherit; padding: 0.75rem;background-color: #455a64; color: #fff; vertical-align: bottom; border: 1px solid rgb(221, 221, 221) !important;">
                                                                        Tên SP</th>
                                                                    <th
                                                                        style="text-align: inherit;background-color: #455a64; color: #fff; padding: 0.75rem; vertical-align: bottom; border: 1px solid rgb(221, 221, 221) !important;">
                                                                        Số lượng</th>
                                                            ...
                                                            <tfoot>
                                                                <tr style="break-inside: avoid;">
                                                                    <td colspan="4"
                                                                        style="font-family: Roboto, RobotoDraft, Helvetica, Arial, sans-serif; margin: 0px; padding: 0.75rem; vertical-align: top; border: 1px solid rgb(221, 221, 221) !important;">
                                                                        <span><span style="
                                                                            display: inline-block;
                                                                            width: 50%;
                                                                            text-align: left;">Tổng tiền hàng:</span>
                                                                            <span>{{TOTAL}}</span></span><br><br>
                                                                        <span><span style="
                                                                                display: inline-block;
                                                                                width: 50%;
                                                                                text-align: left;">Tổng tiền phí vận
                                                                                chuyển:</span>
                                                                            <span>Miễn phí</span></span><br><br>
                                                                        <span style="
                                                                            display: inline-block;
                                                                            width: 50%;
                                                                            text-align: left;">Tổng thanh
                                                                            toán:</span><span
                                                                            style="color: rgb(220, 53, 69) !important;">{{TOTALPAYMENT}}
                                                                            VNĐ</span>
                                                                    </td>
                                                                </tr>
                                                            </tfoot>
                                                        ...
                                                        <p
                                                            style="color: rgb(72, 74, 76); font-family: Arial, Helvetica, sans-serif; font-size: 14px;">
                                                            Đơn hàng của bạn sẽ được giao về địa
                                                            chỉ:&nbsp;<b>{{ADDRESS}}</b></p>
                                                    </td>
                                                </tr>
                                            </tbody>
